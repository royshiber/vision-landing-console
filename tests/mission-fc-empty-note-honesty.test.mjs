...
function loadHonestyUi() {
  ...
  const src = [
    ...
    sliceFunction(js, 'airspeedTileHonestyTitle'),
    sliceFunction(js, 'classifyEkfGpsStatusText'),
    sliceFunction(js, 'pickHudEkfGpsHint'),
    sliceFunction(js, 'formatGpsHudReadout'),
    ...
    'const document = { querySelector(sel) { return sel === ".mission-horizon-filler-note" ? note : null; }, getElementById() { return null; } };',
