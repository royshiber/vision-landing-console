...
function blockedAnswerFor(resolved) {
  ...
  if (kind === 'ARM' || kind === 'DISARM' || kind === 'LANDING_COMMAND' || kind === 'MODE_CHANGE' || kind === 'FC_COMMAND') {
...
export function createAssistService({
  ...
  function makeProposal(actionType, payload, { requiresConfirmation = true } = {}) {
    ...
    // Roy lock voice_direct_after_go — param apply is confirm-required until session GO.
