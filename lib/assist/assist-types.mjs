...
/** Mission is an ops surface: notes, observations, known-route nav, confirm-or-GO param propose. No coding-agent start. */
...
/**
 * Explicitly rejected as proposal action types — Ask must never propose these.
 * LAND / RTL / mode after an open voice session use applyFlightOp, not this list.
 * ARM / DISARM stay blocked and are never sent. PARAM_WRITE stays a direct-write ban.
 * Safe param work is PROPOSE_PARAM_CHANGE and always confirm-required (oral OK).
 */
