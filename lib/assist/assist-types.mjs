 ...
 * (confirm-required until session GO; direct engineer apply after GO).
 * ARM / LAND / auto-land / live nav switch stay blocked
 * (Roy 2026-09-12 early-flight Human Gate). GO does not unlock them.
 */
