 ...
 *
 * Roy 2026-09-12 voice_direct_after_go: SAFE param intents are confirm-required
 * until session GO, then apply via the engineer path without per-action confirm.
