...
export const ASSIST_HE = Object.freeze({
  ...
  voiceSessionRequired: 'שיחת הקול סגורה. לחצו GO או אמרו יאללה כדי לפתוח שיחה. אחרי ההפעלה, נחיתה ושינוי מצב מתבצעים בלי אישור נוסף.',
  ...
  flightOpModeNotAllowed: 'המצב הזה לא זמין בפקודה קולית. לא נשלח דבר.',
  flightOpNumericMode: 'אי אפשר לבקש מצב לפי מספר. אמרו את שם המצב. לא נשלח דבר.',
  ...
  voiceGoHintIdle: 'הפעלה פותחת שיחת קול. אחרי ההפעלה, נחיתה ושינוי מצב מתבצעים בלי אישור נוסף. חימוש ונטרול נשארים חסומים, ושינוי פרמטר עדיין דורש אישור.',
  voiceGoHintActive: 'שיחת הקול פתוחה. אחרי ההפעלה, נחיתה ושינוי מצב מתבצעים בלי אישור נוסף. חימוש ונטרול נשארים חסומים, ושינוי פרמטר עדיין דורש אישור.',
...
export function hebrewReadbackAnswer(topic, ac, spokenUnits) {
  ...
  if (topic === 'mode') {
    const mode = ac?.flight_mode ? String(ac.flight_mode) : 'אין נתונים';
