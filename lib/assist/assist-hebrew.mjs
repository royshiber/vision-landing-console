...
export const ASSIST_HE = Object.freeze({
  ...
  blockedFlightCommandAnswer: [
    'הבקשה היא פקודת טיסה.',
    'דורש שער אדם / לא בטיסות ראשונות.',
    'AIRVIX Ask לא ישלח חימוש, נטרול, נחיתה, או חזרה הביתה לבקר.',
  ].join('\n'),
  ...
  paramProposalAnswer: 'מציע שינוי פרמטר. נדרש אישור מפורש לכל פעולה. אמרו מאשר או לחצו אישור.',
  ...
  voiceConfirmHint: 'אמרו מאשר או לחצו אישור.',
  voiceGoEnabled: 'הופעל. שינוי פרמטר מוחל בלי אישור לכל פעולה. חימוש ונחיתה נשארים חסומים.',
  voiceGoDisabled: 'כבוי. שינוי פרמטר דורש אישור. חימוש ונחיתה נשארים חסומים.',
  voiceGoHintIdle: 'הפעלה מאפשרת החלת פרמטר בלי אישור לכל פעולה. חימוש ונחיתה נשארים חסומים.',
  voiceGoHintActive: 'מופעל. שינוי פרמטר מוחל מיד. חימוש ונחיתה נשארים חסומים.',
