...
export const ASSIST_ROUTES = Object.freeze([
  ...
  },
  {
    ...
    description: 'Computer status / Jetson version home — Maintenance tab removed',
  },
  {
    id: 'debrief',
    workspace: 'PLATFORM',
    capability: 'debrief',
    tab: 'recordings',
    labels: ['debrief', 'recordings', 'logs', 'flights', 'תחקור', 'אופטיקה ותחקור', 'הקלטות', 'לוגים', 'טיסות'],
  ...
  },
  {
    ...
    capability: 'video',
    tab: 'optics',
    labels: ['optics', 'אופטיקה', 'מצלמות'],
    description: 'Live cameras, gimbal, and calibration',
  },
  {
    id: 'pulse_proxy',
    workspace: 'PULSE',
    capability: 'diagnostics',
    tab: 'pulse',
    labels: ['pulse', 'home', 'overview', 'סקירה', 'תמונת מצב', 'בית', 'סטטוס מחשבים'],
  ...
  },
  {
    ...
    description: 'Platform tab removed — opens computer status',
  },
]);
