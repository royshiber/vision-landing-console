...
export const ASSIST_ROUTES = Object.freeze([
  ...
  },
  {
    ...
    capability: 'mission',
    tab: 'terrain',
    labels: ['מוכנות', 'readiness', 'נחיתה ויזואלית', 'ניסוי נחיתה', 'ניסוי אחד', 'vision landing'],
    description: 'Experiment #1 readiness — observe-only runway detection, PIC hand-fly',
  },
  {
    id: 'vision',
    workspace: 'PLATFORM',
