...
export const ASSIST_ROUTES = Object.freeze([
  ...
  },
  {
    ...
    capability: 'lab_sitl',
    tab: 'simLab',
    labels: ['lab', 'sitl', 'sim', 'simulation', 'מעבדה', 'סימולציה'],
  ...
  },
  {
    ...
    capability: 'advisor',
    tab: 'advisor',
    labels: ['advisor', 'ai advisor', 'יועץ', 'יועץ מעבדה'],
    description: 'Lab advisor shelf — Assist routes Q&A here',
  },
  {
    id: 'ardulab',
    workspace: 'EVOLVE',
  ...
  },
  {
    ...
    capability: 'voice',
    tab: 'flightEngineer',
    labels: ['flight engineer', 'voice engineer', 'engineer', 'flightengineer', 'מהנדס', 'מהנדס טיסה', 'מהנדס מעבדה', 'מהנדס קולי'],
  ...
  },
  {
    ...
    tab: 'maintenance',
    labels: ['companion', 'Companion', 'maintenance', 'jetson', 'תחזוקה', 'מלווה'],
