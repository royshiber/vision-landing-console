 ...
 * JETSON_COMPANION_BASE_URLS is an ordered failover list. JETSON_COMPANION_BASE_URL
 * still works alone, or as extra addresses appended after that list.
 * Real requires BOTH COMPANION_MODE=real AND at least one of those URLs.
 * A URL alone never enables real.
