...
export function opticalNavStub({ present = false, running = false, cameraOk = false, confidence = null, note } = {}) {
  return {
    ...
    display_only: true,
    cameras: {
      cam1: { id: "cam1", role: "vio_forward", shared_with: "landing_vision", camera_ok: cameraOk },
      cam2: { id: "cam2", role: "optical_flow_down", shared_with: "landing_vision", camera_ok: cameraOk },
    },
