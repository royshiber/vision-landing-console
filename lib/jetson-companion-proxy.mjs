/**
 * LEGACY/FROZEN Jetson companion HTTP helper (heartbeat :8081 install/logs).
 * New aircraft reads go through lib/companion-api-client.mjs → /api/v1.
 * Do not add ARM/DISARM/SET_MODE/LAND here.
 */
