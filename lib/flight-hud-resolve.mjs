...
const SYNONYMS = {
  'mavlink.airspeed': ['ias', 'indicated', 'airspd', 'אוויר', 'airspeed', 'מד אוויר'],
  'mavlink.groundspeed': ['gs', 'ground', 'groundspeed', 'קרקע', 'קרקעית', 'mgd'],
  'mavlink.altitude': ['alt', 'altitude', 'גבה', 'גובה', 'מ״מ', 'ממ״ג'],
  'mavlink.heading': ['hdg', 'heading', 'כיוון', 'יאו', 'אזימוט'],
  ...
  'mavlink.rollDeg': ['roll', 'גלגול', 'הטיה רוחב'],
  'mavlink.pitchDeg': ['pitch', 'דקירה', 'פיץ'],
