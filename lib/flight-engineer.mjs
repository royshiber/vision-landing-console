...
export async function engineerChat(db, { text, sessionId, telemetry = null, fcParams = null, jetson = null, vision = null, slam = null, memory = '', modeInstruction = '', history = [], flightId = null }) {
  ...
  for (const modelId of modelChain) {
    try {
      ...
      logger.info({ modelId, sessionId, actions: executedActions.length }, '[flight-engineer] chat ok');
      return {
        text: replyText,
 ...
 * Caller is responsible for piping to res.
 * @param {string} text
 * @param {string} [_lang]
...
export async function streamTts(text, _lang = 'he', opts = {}) {
  ...
  return resp.body; // Node.js readable stream
}
