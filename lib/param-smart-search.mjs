...
const STATIC_MATCH_LINES = {
  ...
  companion_serial_port: {
    label_he: 'פורט SERIAL4 בבקר, רפידות TX3 ו-RX3, קצב 921600.',
    label_en: 'companion_serial_port — SERIAL4 on pads TX3/RX3 at 921600',
  },
  companion_sr_bucket: {
    label_he: 'מאיזה ערוץ SRx נשלחים קצבי הטלמטריה (Hz) למחשב המשימה — קשור לרענון המסך והלוגים.',
