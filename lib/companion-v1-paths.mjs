...
export const COMPANION_V1_PATHS = Object.freeze({
  ...
  cam1Status: '/api/v1/cam1/status',
  cam1Health: '/api/v1/cam1/health',
  cam1Settings: '/api/v1/cam1/settings',
  cam1Snapshot: '/api/v1/cam1/snapshot.png',
  cam1Stream: '/api/v1/cam1/stream.mjpg',
  ...
  versionsBackups: '/api/v1/versions/backups',
  versionsRollback: '/api/v1/versions/rollback',
  versionsKnownGood: '/api/v1/versions/known-good',
...
export const COMPANION_WRITE_METHODS = Object.freeze([
  ...
  'postVersionsRollback',
  'postVersionsKnownGood',
  'setNetworkUplink',
  'postCam0Settings',
  'postCam1Settings',
  'postCam0Module',
