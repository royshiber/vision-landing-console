...
export const ARCHIVE_COPY_HE = Object.freeze({
  startOk: 'הקלטה התחילה. הנתונים נשמרים לארכיון.',
  startAlready: 'ההקלטה כבר פעילה.',
  startFail: 'לא הצלחנו לפתוח קובץ הקלטה.',
  startNoLink: 'אין קישור פעיל. הקובץ יישאר ריק עד שיגיעו נתונים.',
  stopOk: 'ההקלטה נעצרה. הסשן נסגר.',
  stopEmpty: 'ההקלטה נעצרה. לא נשמרו נתונים.',
...
export function snapshotRecordingState({
  ...
  return {
    ...
    noteHe: armed
      ? 'הקלטה פעילה. הנתונים נשמרים לארכיון.'
