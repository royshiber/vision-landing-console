...
export function createCompanionApiClient(opts = {}) {
  ...
  const client = {
    ...
    /**
     * Latest JPEG for cam1..cam3. 404 / empty is honest אין פריים — never invent a frame.
     * @param {'cam1'|'cam2'|'cam3'|string} camId
     */
    ...
    getStatusAutoland: () => request(COMPANION_V1_PATHS.statusAutoland),
