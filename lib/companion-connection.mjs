...
export const COMPANION_HE = Object.freeze({
  ...
  disconnected: 'Companion מנותק',
  connected: 'Companion מחובר',
  mock: 'Companion במצב מדומה',
  connecting: 'מחברים Companion',
  connectFailed: 'חיבור Companion נכשל',
  timeout: 'חיבור Companion ארך יותר מדי',
  unauthorized: 'האסימון נדחה. בדקו את האסימון ונסו שוב.',
  bothGate: 'כתובת לבד לא מספיקה. צריך גם אסימון.',
  httpError: 'שגיאת שרת Companion',
  parse: 'תשובת Companion אינה תקינה',
